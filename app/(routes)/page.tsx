...
export default function Home() {
  return (
    <main className="flex min-h-screen items-center justify-center overflow-hidden bg-neutral-primary bg-[url('/home-bg.png')] bg-cover bg-center bg-no-repeat p-8">
